<!-- notice modal -->
<div class="modal fade" id="add-persona-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header-primary">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">clear</i></button>
                <h6>INGRESAR AVENTURERO</h6>
            </div>
            <div class="modal-body">
                <div class="row">
        <div class="col-md-12">
            <form role="form" id="form-user-add">
            {{ csrf_field() }}
                <div class="content">
                    <div class="row">
                        <div class="col-md-6"> 
            ...
            <div class="modal-footer text-center">
                <a href="#" id="btn-add-user" class="btn btn-primary pull-right">Guardar</a>
            </div>
        </div>
    </div>
</div>
